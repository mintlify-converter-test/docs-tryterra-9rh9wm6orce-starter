---
title: "Setup Terra SDK on iOS"
description: "Guide for integrating Terra SDK in iOS apps, including installation, initialization, connection, and data retrieval"
---
