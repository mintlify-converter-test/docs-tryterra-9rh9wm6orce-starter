---
title: "Setup Consumer Connection with Terra WebSockets"
description: "Guide to setup a consumer connection to read data from wearables streaming via Terra WebSockets."
---
